...
let col, x, z;
const numRows = 24;
const spaceBetweenCols = 0.1 * stripLen;
const spaceBetweenRows = 0.15 * stripLen;
 ...
 */
const universeHyperspaceWarp = [2, 0, 1],
	channelingus = [0, 420, 330];
let universe = -1;
const fArtNetPairs = [];
...
function buildNagBugglerSaberOfLightFixturesBM() {
	...
	return [
		{
			...s(
				{ yaw: -90, x: sl(24 * vSpace), y: sl(1), z: 0 },
				"r-v2-24 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(23 * vSpace), y: sl(1), z: 0 },
				"r-v2-23 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(22 * vSpace), y: sl(1), z: 0 },
				"r-v2-22 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(21 * vSpace), y: sl(1), z: 0 },
				"r-v2-21 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(20 * vSpace), y: sl(1), z: 0 },
				"r-v2-20 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(19 * vSpace), y: sl(1), z: 0 },
				"r-v2-19 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(18 * vSpace), y: sl(1), z: 0 },
				"r-v2-18 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(17 * vSpace), y: sl(1), z: 0 },
				"r-v2-17 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(16 * vSpace), y: sl(1), z: 0 },
				"r-v2-16 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(15 * vSpace), y: sl(1), z: 0 },
				"r-v2-15 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(14 * vSpace), y: sl(1), z: 0 },
				"r-v2-14 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(13 * vSpace), y: sl(1), z: 0 },
				"r-v2-13 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(12 * vSpace), y: sl(1), z: 0 },
				"r-v2-12 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(11 * vSpace), y: sl(1), z: 0 },
				"r-v2-11 sq2 col1",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(10 * vSpace), y: sl(1), z: 0 },
				"r-v2-10 sq2 col1",
			),
		},
		{
		...
		{
			...s(
				{ yaw: -90, x: sl(24 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-24 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(23 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-23 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(22 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-22 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(21 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-21 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(20 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-20 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(19 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-19 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(18 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-18 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(17 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-17 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(16 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-16 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(15 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-15 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(14 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-14 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(13 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-13 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(12 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-12 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(11 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-11 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(10 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-10 sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(9 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-9  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(8 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-8  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(7 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-7  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(6 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-6  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(5 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-5  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(4 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-4  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(3 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-3  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(2 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-2  sq2 col2",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(1 * vSpace), y: sl(1), z: sl(1 + 1 * hSpace) },
				"r-v2-1  sq2 col2",
			),
		},
		...
		{
			...s(
				{ yaw: -90, x: sl(24 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-24 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(23 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-23 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(22 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-22 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(21 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-21 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(20 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-20 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(19 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-19 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(18 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-18 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(17 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-17 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(16 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-16 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(15 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-15 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(14 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-14 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(13 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-13 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(12 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-12 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(11 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-11 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(10 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-10 sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(9 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-9  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(8 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-8  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(7 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-7  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(6 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-6  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(5 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-5  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(4 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-4  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(3 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-3  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(2 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-2  sq2 col3",
			),
		},
		{
			...s(
				{ yaw: -90, x: sl(1 * vSpace), y: sl(1), z: sl(2 + 2 * hSpace) },
				"r-v2-1  sq2 col3",
			),
		},
...
function buildNagBugglerSaberOfLightFixtures_v1() {
	return [
        ...
        */
		{
			...s(
				{ roll: -90, x: sl(0), z: sl(0 * 1.5) },
				"pc7 pc7-s3 ps ps-e7 po po-cw9 sq3 sq3-cw5",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(0 * 1.5) },
				"pc7 pc7-s2 pm pm-e7 po po-cw8 sq3 sq3-cw4",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(0 * 1.5) },
				"pc7 pc7-s1 pn pn-e7 po po-cw7 sq3 sq3-cw3",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(1 * 1.5) },
				"pc6 pc6-s3 ps ps-e6 po po-cw10 sq3 sq3-cw6",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(1 * 1.5) },
				"pc6 pc6-s2 pm pm-e6 pi pi-e5   sq3        ",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(1 * 1.5) },
				"pc6 pc6-s1 pn pn-e6 po po-cw6  sq3 sq3-cw2",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(2 * 1.5) },
				"pc5 pc5-s3 ps ps-e5 po po-cw11 sq3 sq3-cw7 sq2 sq2-cw5",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(2 * 1.5) },
				"pc5 pc5-s2 pm pm-e5 pi pi-e4   sq3 sq3-cw8 sq2 sq2-cw4",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(2 * 1.5) },
				"pc5 pc5-s1 pn pn-e5 po po-cw5  sq3 sq3-cw1 sq2 sq2-cw3",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(3 * 1.5) },
				"pc4 pc4-s3 ps ps-e4 po po-cw12 sq2 sq2-cw6",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(3 * 1.5) },
				"pc4 pc4-s2 pm pm-e4 pi pi-e3   sq2        ",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(3 * 1.5) },
				"pc4 pc4-s1 pn pn-e4 po po-cw4  sq2 sq2-cw2",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(4 * 1.5) },
				"pc3 pc3-s3 ps ps-e3 po po-cw13 sq2 sq2-cw7 sq1 sq1-cw5",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(4 * 1.5) },
				"pc3 pc3-s2 pm pm-e3 pi pi-e2   sq2 sq2-cw8 sq1 sq1-cw4",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(4 * 1.5) },
				"pc3 pc3-s1 pn pn-e3 po po-cw3  sq2 sq2-cw1 sq1 sq1-cw3",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(5 * 1.5) },
				"pc2 pc2-s3 ps ps-e2 po po-cw12 sq1 sq1-cw6",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(5 * 1.5) },
				"pc2 pc2-s2 pm pm-e2 pi pi-e1   sq1        ",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(5 * 1.5) },
				"pc2 pc2-s1 pn pn-e2 po po-cw4  sq1 sq1-cw2",
			),
		},

		{
			...s(
				{ roll: -90, x: sl(0), z: sl(6 * 1.5) },
				"pc1 pc1-s3 ps ps-e1 po po-cw15 sq1 sq1-cw7",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(1.5), z: sl(6 * 1.5) },
				"pc1 pc1-s2 pm pm-e1 po po-cw16 sq1 sq1-cw8",
			),
		},
		{
			...s(
				{ roll: -90, x: sl(3), z: sl(6 * 1.5) },
				"pc1 pc1-s1 pn pn-e1 po po-cw1  sq1 sq1-cw1",
			),
		},
		...
		{
			...s(
				{ yaw: 180, x: sl(1), z: sl(1 * 3) },
				"rc3 rc1-s3 sq2 sq2-cw6 sq3 sq3-cw10",
			),
		},
		{
			...s(
				{ yaw: 180, x: sl(2), z: sl(1 * 3) },
				"rc3 rc1-s2 sq2 sq2-cw5 sq3 sq3-cw11",
			),
		},
		{
			...s(
				{ yaw: 180, x: sl(3), z: sl(1 * 3) },
				"rc3 rc1-s1 sq2 sq2-cw4 sq3 sq3-cw12",
			),
		},
		// #45 - #47
		{
			...s(
				{ yaw: 180, x: sl(1), z: sl(2 * 3) },
				"rc2 rc1-s3 sq1 sq1-cw6 sq2 sq2-cw10",
			),
		},
		{
			...s(
				{ yaw: 180, x: sl(2), z: sl(2 * 3) },
				"rc2 rc1-s2 sq1 sq1-cw5 sq2 sq2-cw11",
			),
		},
		{
			...s(
				{ yaw: 180, x: sl(3), z: sl(2 * 3) },
				"rc2 rc1-s1 sq1 sq1-cw4 sq2 sq2-cw12",
			),
		},
		// #48 - #50
		...
		{
			...s(
				{ yaw: -45, x: sl(0.75), z: sl(0.75) },
				"x3-3 sq3 sq3-se3 x xi xi-cw3",
			),
		},
		{ ...s({ yaw: +45, x: 0, z: sl(3) }, "x4-3 sq3 sq3-nw1 x xo xo-cw4") },
		{
			...s(
				{ yaw: +45, x: sl(0.75), z: sl(3) - sl(0.75) },
				"x4-3 sq3 sq3-nw2 x xi xi-cw4",
			),
		},
		{ ...s({ yaw: -135, x: sl(3), z: 0 }, "x2-3 sq3 sq3-nw4 x xo xo-cw2") },
		{
			...s(
				{ yaw: -135, x: sl(3) - sl(0.75), z: sl(0.75) },
				"x2-3 sq3 sq3-nw3 x xi xi-cw2",
			),
		},
		{ ...s({ yaw: +135, x: sl(3), z: sl(3) }, "x1-3 sq3 sq3-se1 x xo xo-cw1") },
		{
			...s(
				{ yaw: +135, x: sl(3) - sl(0.75), z: sl(3) - sl(0.75) },
				"x1-3 sq3 sq3-se2 x xi xi-cw1",
			),
		},
		...
		{ ...s({ yaw: -45, x: 0, z: sl(3) }, "x3-2 sq2 sq2-se4 x xo xo-cw3") },
		{
			...s(
				{ yaw: -45, x: sl(0.75), z: sl(3) + sl(0.75) },
				"x3-2 sq2 sq2-se3 x xi xi-cw3",
			),
		},
		{
			...s(
				{ yaw: +45, x: 0, z: sl(3) + sl(3) },
				"x4-2 sq2 sq2-nw1 x xo xo-cw4",
			),
		},
		{
			...s(
				{ yaw: +45, x: sl(0.75), z: sl(3) + sl(3) - sl(0.75) },
				"x4-2 sq2 sq2-nw2 x xi xi-cw4",
			),
		},
		{ ...s({ yaw: -135, x: sl(3), z: sl(3) }, "x2-2 sq2 sq2-nw4 x xo xo-cw2") },
		{
			...s(
				{ yaw: -135, x: sl(3) - sl(0.75), z: sl(3) + sl(0.75) },
				"x2-2 sq2 sq2-nw3 x xi xi-cw2",
			),
		},
		{
			...s(
				{ yaw: +135, x: sl(3), z: sl(3) + sl(3) },
				"x1-2 sq2 sq2-se1 x xo xo-cw1",
			),
		},
		{
			...s(
				{ yaw: +135, x: sl(3) - sl(0.75), z: sl(3) + sl(3) - sl(0.75) },
				"x1-2 sq2 sq2-se2 x xi xi-cw1",
			),
		},
		...
		{
			...s(
				{ yaw: -45, x: sl(0.75), z: sl(6) + sl(0.75) },
				"x3-1 sq1 sq1-se3 x xi xi-cw3",
			),
		},
		{
			...s(
				{ yaw: +45, x: 0, z: sl(6) + sl(3) },
				"x4-1 sq1 sq1-nw1 x xo xo-cw4",
			),
		},
		{
			...s(
				{ yaw: +45, x: sl(0.75), z: sl(6) + sl(3) - sl(0.75) },
				"x4-1 sq1 sq1-nw2 x xi xi-cw4",
			),
		},
		{ ...s({ yaw: -135, x: sl(3), z: sl(6) }, "x2-1 sq1 sq1-nw4 x xo xo-cw2") },
		{
			...s(
				{ yaw: -135, x: sl(3) - sl(0.75), z: sl(6) + sl(0.75) },
				"x2-1 sq1 sq1-nw3 x xi xi-cw2",
			),
		},
		{
			...s(
				{ yaw: +135, x: sl(3), z: sl(6) + sl(3) },
				"x1-1 sq1 sq1-se1 x xo xo-cw1",
			),
		},
		{
			...s(
				{ yaw: +135, x: sl(3) - sl(0.75), z: sl(6) + sl(3) - sl(0.75) },
				"x1-1 sq1 sq1-se2 x xi xi-cw1",
			),
		},
	];
}
...
function defaultNagBugglerSaberOfLight(params, tags, labelParam, artNetPair) {
	id++;
	const i = id - 101;
	let fixtureTags = `strip ${id - 100 <= numPillars ? "pillar" : "rafter"} f${
		id - 101
	}`;
	if (tags) fixtureTags += " " + tags.split(/\s+/gi).join(" ");
	return {
		id: id,
		...
		parameters: {
			...
			host: controllerIP,
			port: controllerPort,
			artNetUniverse: artNetPair
				? artNetPair.universe
				: fArtNetPairs[mapStripToArtnetPair(i)][0],
			dmxChannel: artNetPair
				? artNetPair.channel
				: fArtNetPairs[mapStripToArtnetPair(i)][1],
...
function addNets() {
	...
	function hang(x, z) {
		fixtures.push(
			netStrip(
				{ x: x, y: stripLen, z: z, yaw: 0, pitch: 0, roll: -90 },
				"sigh",
			),
		);
	}
...
// count pixels + dmxChannels and output it + universes, to add to flamecaster conf
// zig zag to match BTF folded
// on playa, might need varying size of numPoints per strip, would have to hack that in
let currentUniverseId = -1;
const universes = [];
const last = (arr) => arr[arr.length - 1];
function addScreen(x, z, rows, cols, columnSpacing, heights) {
	universes.push({ id: ++currentUniverseId, pixels: 0 });
	const spacing = 40;
	for (let i = 0; i < cols; i++) {
		const numPoints = heights ? heights[i] : rows;
		// const y = i % 2 === 0 ? stripLen : stripLen - (numPoints - 1) * spacing
		// const roll = i % 2 === 0 ? -90 : 90
		const y = i % 2 === 0 ? stripLen - (numPoints - 1) * spacing : stripLen;
		const roll = i % 2 === 0 ? 90 : -90;
		...
		props = {
			...props,
			artNetUniverse: last(universes).id,
			dmxChannel: last(universes).pixels * 3,
		};
...
let sx = -2400;
let numCols = 16;
addScreen(sx, sz, 18, numCols, columnSpacing);

// sz = -1200;
sz = -columnSpacing * (numCols - 1);
sz += -25;
sx += 0;
numCols = 16;
addScreen(sx, sz, 18, numCols, columnSpacing);
